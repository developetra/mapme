...
public class AddPolylineActivity extends AppCompatActivity implements View.OnClickListener, AppService.AppServiceListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // bind to service
        Intent bindIntent = new Intent(AddPolylineActivity.this, AppService.class);
    ...
    private ServiceConnection appServiceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder service) {
            ...
            appService.registerListener(AddPolylineActivity.this);
